...
- **Slack notifications** — set an enterprise license key (`LMNR_LICENSE_KEY`) in `laminar.yaml` to enable Slack notifications and alerts. This connects your self-hosted instance to the official Laminar Slack app. To get a license key, contact **founders@lmnr.ai**.
